...
export fiftyMil_CitiesByStateSearch() := macro
import std;
...
df:='~final::key::stcitycounty::data::fiftymillion';
...
output(CHOOSEN(sort(if(unique_val,final_out,final_out),city,county),10), named ('Results'));
